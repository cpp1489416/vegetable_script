...
class Ll1StatementAnalyzer{
 ...
 private:
  bool ParseStatement(Lexer* lexer, Statement::Ptr* statement,
      Exception* exception);
  bool ParseExpressionStatement(Lexer* lexer,
      ExpressionStatement::Ptr* statement, Exception* exception);
  bool ParseBlockStatement(Lexer* lexer, BlockStatement::Ptr* statement,
      Exception* exception);
  bool ParseIfStatement(Lexer* lexer, IfStatement::Ptr* statement,
      Exception* exception);
  bool ParseWhileStatement(Lexer* lexer, WhileStatement::Ptr* statement,
      Exception* exception);
  bool ParseForStatement(Lexer* lexer, ForStatement::Ptr* statement,
      Exception* exception);
